...
= 1.5.0 =
* El listado de satélites de cada planeta se muestra ahora ordenado por defecto por distancia al planeta (antes era por nombre), para que aparezcan en su orden natural.
